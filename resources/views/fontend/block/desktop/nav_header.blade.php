                ...
                <div class="nav-panel__departments">
                    ...
                    @php
                        ...
                        if (Route::currentRouteName() === 'home') {
                            $classOpenMenu = 'departments--open departments--fixed';
                        }
                    @endphp
                    <div class="departments {{ $classOpenMenu }}" data-departments-fixed-by=".block-slideshow">
                        <div class="departments__body">
                            <div class="departments__links-wrapper">
                                ...
                                <ul class="departments__links">
                                    <li class="departments__item">
                                        <a class="departments__item-link" href="">Power Tools 
                                            <svg class="departments__item-arrow" width="6px" height="9px">
                                                <use
                                                    xlink:href="{{ asset('fontend/images/sprite.svg#arrow-rounded-right-6x9') }}">
                                                </use>
                                            </svg>
                                        </a>
                                        <div
                                            ...
                                            <div class="megamenu megamenu--departments">
                                                <div class="megamenu__body" style="background-image: url('{{ asset('fontend/images/megamenu/megamenu-1.jpg') }}');">
                                                    <div class="row">
                                                        <div class="col-3">
                                                            <ul
                                        ...
                                        <div
                                            ...
                                            <div class="megamenu megamenu--departments">
                                                <div class="megamenu__body"
                                                    style="background-image: url('{{ asset('fontend/images/megamenu/megamenu-2.jpg') }}');">
                                                    <div class="row">
                                                        <div class="col-4">
                                                            <ul
                                                                class="megamenu__links megamenu__links--level--0">
                                    ...
                                    <li class="departments__item">
                                        <a class="departments__item-link" href="">Machine Tools 
                                            <svg class="departments__item-arrow" width="6px" height="9px">
                                                <use xlink:href="{{ asset('fontend/images/sprite.svg#arrow-rounded-right-6x9') }}"></use>
                                            </svg>
                                        </a>
                                        <div
                                            ...
                                            <div class="megamenu megamenu--departments">
                                                <div class="megamenu__body"
                                                    style="background-image: url('{{ asset('fontend/images/megamenu/megamenu-3.jpg') }}');">
                                                    <div class="row">
                                                        <div class="col-6">
                                ...
                                <use xlink:href="{{ asset('fontend/images/sprite.svg#menu-18x14') }}"></use>
                            </svg> Shop By Category <svg class="departments__button-arrow" width="9px"
                                height="6px">
                                <use xlink:href="{{ asset('fontend/images/sprite.svg#arrow-rounded-down-9x6') }}"></use>
                            </svg></button>
                    </div><!-- .departments / end -->
                </div><!-- .nav-links -->
                <div class="nav-panel__nav-links nav-links">
                    <ul class="nav-links__list">
                        <li class="nav-links__item nav-links__item--has-submenu"><a
                                ...
                                <div class="nav-links__item-body">Home <svg
                                        class="nav-links__item-arrow" width="9px" height="6px">
                                        <use xlink:href="{{ asset('fontend/images/sprite.svg#arrow-rounded-down-9x6') }}">
                                        </use>
                                    </svg></div>
                            </a>
                ...
                <div class="nav-panel__indicators">
                    <div class="indicator"><a href="wishlist.html" class="indicator__button"><span
                                class="indicator__area"><svg width="20px" height="20px">
                                    <use xlink:href="{{ asset('fontend/images/sprite.svg#heart-20') }}"></use>
                    ...
                    <div class="indicator indicator--trigger--click"><a href="cart.html"
                            class="indicator__button"><span class="indicator__area"><svg width="20px"
                                    height="20px">
                                    <use xlink:href="{{ asset('fontend/images/sprite.svg#cart-20') }}"></use>
                                        ...
                                        <div class="dropcart__product">
                                            <div class="product-image dropcart__product-image"><a
                                                    href="product.html" class="product-image__body"><img
                                                        ...
                                                        src="{{ asset('fontend/images/products/product-1.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="dropcart__product-info">
                                                ...
                                                class="dropcart__product-remove btn btn-light btn-sm btn-svg-icon"><svg
                                                    ...
                                                    <use xlink:href="{{ asset('fontend/images/sprite.svg#cross-10') }}"></use>
                                                </svg></button>
                                        </div>
                                        <div class="dropcart__product">
                                            <div class="product-image dropcart__product-image"><a
                                                    href="product.html" class="product-image__body"><img
                                                        class="product-image__img"
                                                        src="{{ asset('fontend/images/products/product-2.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="dropcart__product-info">
                                                <div class="dropcart__product-name"><a
                                        ...
                                        <div class="dropcart__product">
                                            <div class="product-image dropcart__product-image">
                                                <a href="product.html" class="product-image__body">
                                                    <img class="product-image__img" src="{{ asset('fontend/images/products/product-5.jpg') }}" alt="">
                                                </a>
                                            </div>
                                            <div class="dropcart__product-info">
                        ...
                        <a href="account-login.html" class="indicator__button">
                            <span class="indicator__area">
                                <svg width="20px" height="20px">
                                    <use xlink:href="{{ asset('fontend/images/sprite.svg#person-20') }}"></use>
                                </svg>
                            </span>
                        </a>
                        <div class="indicator__dropdown">
                            <div class="account-menu">
                                ...
                                <a href="account-dashboard.html" class="account-menu__user">
                                    <div class="account-menu__user-avatar">
                                        <img src="{{ asset('fontend/images/avatars/avatar-3.jpg') }}" alt="">
                                    </div>
