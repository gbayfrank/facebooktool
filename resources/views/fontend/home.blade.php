...
@section('content')
<!-- .block-slideshow -->
@include('fontend.block.slideshow')
<!-- .block-slideshow / end -->
<!-- .block-features -->
@include('fontend.block.features')
<!-- .block-features / end -->
<!-- .block-products-carousel -->
@include('fontend.block.products-carousel')
<!-- .block-products-carousel / end -->
<!-- .block-banner -->
@include('fontend.block.banner')
<!-- .block-banner / end -->
<!-- .block-products -->
@include('fontend.block.products')
<!-- .block-products / end -->
<!-- .block-categories -->
